...
# 2c. Investigate how the consensus ID forms ------------------------------------------
...
# 2d. Sensitivity to alphabetical order -----------------------------------
# Does the way in which the consensus split is chosen affect the results?
# Excluding points with no consensus
...
# 3. Influence of size ----------------------------------------------------
# # 3a. Sizes comparisons between >150 from >125 ------------------------------
# # 
...
conf_mat(long$f125[long$f125$Person == "1a",], "dCID", "sCID", spec.abb = sp.abb[!(sp.abb$Abbreviation %in% c('nca', 'nc')), ], abb.end = c("na"), xlab = "Digital", ylab = "Slide", palette = "plasma", grid = TRUE, type = "CvC")
...
conf_mat(long$f150[long$f150$Person == "1a",], "dCID", "sCID", spec.abb = sp.abb[!(sp.abb$Abbreviation %in% c('nca', 'nc')), ], abb.end = c("na"), xlab = "Digital", ylab = "Slide", palette = "plasma", grid = TRUE, type = "CvC")
...
conf_mat(long$f125[long$f125$Person == "1a",], "dCIDnc", "sCIDnc", spec.abb = sp.abb[!(sp.abb$Abbreviation %in% c('nc')), ], abb.end = c("nca"), xlab = "Digital", ylab = "Slide", palette = "plasma", grid = TRUE, type = "CvC")
text(-1, 1, "Consensus 125", cex = 1.5)
dev.off()
...
conf_mat(long$f150[long$f150$Person == "1a",], "dCIDnc", "sCIDnc", spec.abb = sp.abb[!(sp.abb$Abbreviation %in% c('nc')), ], abb.end = c("nca"), xlab = "Digital", ylab = "Slide", palette = "plasma", grid = TRUE, type = "CvC")
text(-1, 1, "Consensus 150", cex = 1.5)
dev.off()
...
conf_mat(long$f125[long$f125$Person == "1a",], "dSC50", "sSC50", spec.abb = sp.abb, abb.end = c("nc"), xlab = "Digital", ylab = "Slide", grid = TRUE, palette = "plasma", type = "CvC")
text(-1, 1, "Consensus 125", cex = 1.5)
dev.off()
...
conf_mat(long$f150[long$f150$Person == "1a",], "dSC50", "sSC50", spec.abb = sp.abb, abb.end = c("nc"), xlab = "Digital", ylab = "Slide", grid = TRUE, palette = "plasma", type = "CvC")
text(-1, 1, "Consensus 150", cex = 1.5)
dev.off()
...
# without text
png("ASFigures/CombCon_SST_woText.png", 800, 500)
par(mar = c(5.1, 5.1, 4.1, 2.1))
# points
with(divTemp[divTemp$Size == 150,], plot(1:26, SST10m[match(ord.div, Person)], pch = 16, xaxt = "n", xlab = "Participant", ylab = expression(paste("SST / ", degree, "C")), col = ((Analysis[match(ord.div, Person)] != "Slide")*3 + 1), ylim = c(20.75, 24.35), cex.lab = 1.5, las = 1, cex.axis = 1.1, type = "n"))
axis(1, at = 1:26, labels = ord.div, cex.axis = 1.1)
